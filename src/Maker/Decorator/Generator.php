...
class Generator
{
     ...
     * @throws \Exception
     */
    final public function generateClassFromClassData(
        ClassData $classData,
        string $templateName,
        array $variables = [],
    ...
    public function createClassNameDetails(
        ...
        if (str_contains($namespacePrefix, 'Domain')) {
    ...
    public static function getControllerBaseClass(): ClassNameDetails
    {
        trigger_deprecation(
            'symfony/maker-bundle',
            'v1.41.0',
            'MakerBundle only supports AbstractController. This method will be removed in the future.'
        );
